        ...
        <>
            ...
            <header className="main">
                <div className="main_navbar">
                    <nav className="main_navbar_sign">
                        <div className='main_navbar_sign-links'>Cześć {emailValue}</div>
                        <RouterLink className='main_navbar_sign-links' to="/signIn">Oddaj rzeczy</RouterLink>
                        <RouterLink className='main_navbar_sign-links' to="/logOut">Wyloguj się</RouterLink>
                    </nav>
